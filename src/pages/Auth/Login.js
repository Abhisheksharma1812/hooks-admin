...
function Login() {
  ...
  return (
    <Container className="" style={{minHeight:"100%"}}>
    
      <Card className=" shadow rounded "  style={{maxWidth: "60%", margin:"auto"}}>
      <Card.Body className="">
      <Row className=" d-flex" style={{margin:"-16px"}}>
        {/* Left Side - Image Section */}
        <Col md={5} className="bg-dark text-white text-center d-flex" style={{minHeight:"100%" ,flexDirection:"column",justifyContent:"center",alignItems:"center"}} >
          <img src={LoginLogo} alt="Login Logo" className="img-fluid" style={{ maxWidth: "80%" }} />

          <img src={uIcon} alt="Login Logo" className="img-fluid" style={{ maxWidth: "80%",margin:"17px 0px 0px 0px" }} />
{/*        
        ...
        <h4 className="mb-2 mt-3 text-black fw-bold ">Signin to Your Account</h4>
          <small className="text-muted ">Sign in to create, discover and connect with the global community</small>
...
<div className="mt-4">
              <Form noValidate onSubmit={handleSubmit}>
                ...
                {resultMessage && (
                  <div className={`mt-3 ${messageType === "success" ? "text-success" : "text-danger"} text-center`}>
                    {resultMessage}
                  </div>
                )}
              </Form>
